    ...
    public function getPageDescriptions()
    {
        ...
        $items = [
            ...
            [
                ...
                "page_id" =>22,
                "locale" =>"zh_cn",
                "title" =>"MinhPhan {$version} 新版版本发布！！！",
                "summary" =>"新闻博客做为重要的文字营销工具，是电商网站必不可少的功能之一。博客正文内容支持 HTML 常用标签等.....",
                "content" =>"<p>MinhPhan {$version} 新版版本发布！！！</p>",
                "meta_title" =>"",
                "meta_description" =>"",
                "meta_keywords" =>"",
            ],
            [
                ...
                "page_id" =>22,
                "locale" =>"en",
                "title" =>"MinhPhan {$version} new version released! ! !",
                ...
                "content" =>"<p>MinhPhan {$version} new version released! ! !</p>",
                "meta_title" =>"",
                "meta_description" =>"",
                "meta_keywords" =>"",
            ],
            [
                ...
                "page_id" =>23,
                "locale" =>"zh_cn",
                "title" =>"新一代开源跨境电商系统，MinhPhan重磅上线！",
                "summary" =>"新闻博客做为重要的文字营销工具，是电商网站必不可少的功能之一。博客正文内容支持 HTML 常用标签等...",
                "content" =>"随着一带一路的蓬勃发展，以及中国制造亟需出海拓展全球市场，外贸行业仍然是大国创造GDP的核心引擎.MinhPhan长期深耕跨境电商行业，经过多年的摸索与思考，开发出了一套更加符合国内出海企业需求的开源电商系统&mdash;&mdash;MinhPhan&mdash;&mdash;助力企业品牌出海。",
                "meta_title" =>"",
                "meta_description" =>"",
                "meta_keywords" =>"",
            ],
            [
                ...
                "page_id" =>23,
                "locale" =>"en",
                "title" =>"A new generation of open source cross-border e-commerce system, MinhPhan is launched!",
                "summary" =>"As an important text marketing tool, news blogs are one of the essential functions of e-commerce websites. Blog body content supports HTML common tags, etc.....",
                "content" =>"随着一带一路的蓬勃发展，以及中国制造亟需出海拓展全球市场，外贸行业仍然是大国创造GDP的核心引擎.MinhPhan长期深耕跨境电商行业，经过多年的摸索与思考，开发出了一套更加符合国内出海企业需求的开源电商系统&mdash;&mdash;MinhPhan&mdash;&mdash;助力企业品牌出海",
                "meta_title" =>"",
                "meta_description" =>"",
            ...
            [
                ...
                "page_id" =>24,
                "locale" =>"en",
                "title" =>"MinhPhan multi-language support helps you",
                "summary" =>"As an important text marketing tool, news blogs are one of the essential functions of e-commerce websites. Blog body content supports HTML common tags, etc.....",
            ...
            [
                ...
                "page_id" =>25,
                "locale" =>"zh_cn",
                "title" =>"性能提升秘籍 | 如何打造闪电般快速的 MinhPhan",
                "summary" =>"新闻博客做为重要的文字营销工具，是电商网站必不可少的功能之一。博客正文内容支持 HTML 常用标签等.....",
                "content" =>"新闻博客做为重要的文字营销工具，是电商网站必不可少的功能之一。博客正文内容支持 HTML 常用标签等.....",
                "meta_title" =>"",
                "meta_description" =>"",
            ...
            [
                ...
                "page_id" =>25,
                "locale" =>"en",
                "title" =>"Performance Tips | How to Build a Lightning-Fast MinhPhan",
                "summary" =>"As an important text marketing tool, news blogs are one of the essential functions of e-commerce websites. Blog body content supports HTML common tags, etc.....",
                "content" =>"As an important text marketing tool, news blogs are one of the essential functions of e-commerce websites. Blog body content supports HTML common tags, etc.....",
                "meta_title" =>"",
                "meta_description" =>"",
        ...
        $titleTranslations = [
            ...
            'About' => 'Giới thiệu',
            "MinhPhan {$version} new version released! ! !" => "MinhPhan {$version} ra mắt phiên bản mới",
            'A new generation of open source cross-border e-commerce system, MinhPhan is launched!' => 'MinhPhan ra mắt: nền tảng thương mại điện tử xuyên biên giới thế hệ mới',
            'MinhPhan multi-language support helps you' => 'Hỗ trợ đa ngôn ngữ của MinhPhan giúp bạn bán hàng thuận lợi hơn',
            'Performance Tips | How to Build a Lightning-Fast MinhPhan' => 'Mẹo tối ưu hiệu năng | Cách xây dựng MinhPhan tải nhanh',
        ];
