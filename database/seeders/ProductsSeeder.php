...
class ProductsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if ($products) {
            ...
            foreach ($products as $item) {
                ...
                $item['variables'] = $this->localizeProductVariables($item['variables'] ?? '');
    ...
    private function getProductDescriptions(): array
    {
        ...
        return $this->appendVietnameseLocaleRows($items, 'en');
    }
    ...
    private function localizeProductVariables(?string $variables): array
    {
        $decoded = json_decode($variables ?: '[]', true) ?: [];
        $localized = $this->addVietnameseLocaleToPayload($decoded);

        return json_decode(json_encode($localized, JSON_UNESCAPED_UNICODE));
    }
}
