...
class SetLocaleFromSession
{
    ...
    public function handle(Request $request, Closure $next): mixed
    {
        ...
        $defaultLocale = $this->resolveDefaultLocale($enabledLanguages);
        $locale = $this->resolveLocale($request, $enabledLanguages, $rawPath, $defaultLocale);
    ...
    private function resolveLocale(Request $request, array $enabledLanguages, string $rawPath, string $defaultLocale): string
    {
    ...
    private function resolveDefaultLocale(array $enabledLanguages): string
    {
        $fallbackCandidates = [
            system_setting('base.locale'),
            config('app.locale'),
            config('app.fallback_locale'),
        ];

        foreach ($fallbackCandidates as $candidate) {
            if (is_string($candidate) && $candidate !== '' && in_array($candidate, $enabledLanguages, true)) {
                return $candidate;
            }
        }
