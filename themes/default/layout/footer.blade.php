          ...
          <div class="footer-content-left footer-link-wrap">
            ...
            <div class="intro-wrap">
              @if ($footer_content['content']['intro']['logo'] ?? false)
                <div class="logo"><a href="{{ shop_route('home.index') }}"><img src="{{ image_origin($footer_content['content']['intro']['logo']) }}" alt="{{ system_setting('base.meta_title') ?: 'MinhPhan Commerce' }}" class="img-fluid"></a></div>
              @endif
